...
type InitialProps = {
  ...
  initialProductsMap?: Record<string, any>;
};

export default function AdminReviewsPage({ initialTestimonials, initialProductReviews, initialProductsMap }: InitialProps = {}) {
  ...
  const [productReviews, setProductReviews] = useState<any[]>(initialProductReviews || []);
  const [products, setProducts] = useState<Record<string, any>>(initialProductsMap || {});
