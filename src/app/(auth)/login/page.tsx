...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 bg-gradient-to-br from-cream-50 via-blush-50 to-lavender-50">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <span className="text-5xl block mb-3">🧸</span>
          <h1 className="font-display font-bold text-3xl text-cocoa-700">Bienvenido de vuelta</h1>
          <p className="text-cocoa-400 mt-1">Inicia sesion para continuar</p>
        </div>
        ...
        <div className="bg-white rounded-cute shadow-warm p-8 border border-cream-200">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white px-4 text-cocoa-300 font-medium">o con tu cuenta</span>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (
              <div className="bg-blush-50 border border-blush-200 rounded-2xl px-4 py-3 text-sm text-blush-500 font-medium">
                {error}
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-cute bg-blush-400 text-white py-3 hover:bg-blush-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <p className="text-center text-sm text-cocoa-400 mt-6">
            No tienes cuenta?{' '}
            <Link href="/registro" className="text-blush-400 font-semibold hover:text-blush-500">
              Registrate aqui
            </Link>
          </p>
        </div>
